...
I wanted to point out that this is an Imperial tutorial series, so it will be oriented towards mac users. If you are looking for a good rebel (windows) tutorial, ***[this is a good one](http://i.imgur.com/Yk81R4V.gifv).***

Here are a few points that should get you excited about the command line:

* You can think of the command line as the helm of your very own Star Destroyer.

* When you're at the cantina and you're writing your reports for Grand Moff Tarkin, everyone thinks you're a galactic hacker when they see you using the command line.

* Everything you might normally access on your computer is accessible from the command line, your folders, your downloads, your documents, your death star plans, your photos, your notes, all of it!

* Understanding the command line is basically learning how to talk directly with your computer, you're speaking it's language!

---

## The rest of this exceptionally detailed tutorial has been written by Noah Veltman.
